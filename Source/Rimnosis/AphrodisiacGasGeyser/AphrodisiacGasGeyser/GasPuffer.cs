...
namespace GasPuffer
{
    public class IntermittentACGasSprayer
    {
        public IntermittentACGasSprayer(Thing parent)
        {
            this.parent = parent;
        }
        ...
        {
            MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(ThingDef.Named("AC_Mote_GasPuff"), null);
